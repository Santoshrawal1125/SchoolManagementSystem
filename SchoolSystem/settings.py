...
SECRET_KEY = 'django-insecure-pbe6-*ljs8f&)mrlo7++f2oj16yg9mwwb%)$(h1vc!6vdsh3w#'
...
SIMPLE_JWT = {
    ...
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=2),  # increased the lifespan for sole testing purpose
